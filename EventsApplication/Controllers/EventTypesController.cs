...
namespace EventsApplication.Controllers
{
    ...
    public class EventTypesController : Controller
    {
        ...
        public EventTypesController(IRepositoryWrapper repositoryWrapper)
        {
        ...
        {
            var allEventTypes = repository.EventTypes.FindAll();
            //var allEventType = dbContext.EventTypes.ToList();
            return View(allEventTypes);
        }
        ...
        {
            var EventTypeFound = repository.EventTypes.FindByCondition(e => e.ID == id).FirstOrDefault();
            //var EventTypeById = dbContext.EventTypes.FirstOrDefault(e => e.ID == id);
            return View(EventTypeFound);
        }
        //CREATE
        [Route("create")]
        ...
        public IActionResult Create(AddEventTypeBindingModel bindingModel)
        {
           ...
           repository.EventTypes.Create(EventTypeToCreate);
        ...
        public IActionResult CreateDecorDetail(int EventTypeID)
        {
            ...
            var EventType = repository.EventTypes.FindByCondition(e => e.ID == EventTypeID).FirstOrDefault();
        ...
        public IActionResult CreateDecorDetail(AddDecorDetailBindingModel bindingModel, int EventTypeID)
        {
            ...
            var DecorDetailToCreate = new DecorDetail
            {
                ...
                //EventType = repository.EventTypes.FindByCondition(e => e.ID == EventTypeID).FirstOrDefault(),
            ...
            repository.DecorDetails.Update(DecorDetailToCreate);
            //dbContext.SaveChanges();
            repository.Save();
            return RedirectToAction("Index");
            }
        ...
        {
            //THIS IS WHERE THE ISSUE IS THURSDAY GINI
            ...
            var EventType = repository.EventTypes.FindByCondition(e => e.ID == id).FirstOrDefault();
            //var DecorDetails = repository.DecorDetails.FindByCondition(e => e.EventType.ID == id).FirstOrDefault();
            var DecorDetails= repository.DecorDetails.FindByCondition(e => e.EventTypeID == id);
            ViewBag.EventTypeOccasionName = EventType.OccasionName;
        ...
        {
            //var EventTypeById = dbContext.EventTypes.FirstOrDefault(e => e.ID == id);
            var EventTypeById = repository.EventTypes.FindByCondition(e => e.ID == id).FirstOrDefault();
        ...
        public IActionResult Update(EventType EventType, int id)
        {
            ...
            var EventtypeToUpdate = repository.EventTypes.FindByCondition(e => e.ID == id).FirstOrDefault();
            {
        ...
        public IActionResult Delete(int id)
        {
            ...
            foreach (var e1 in DecorDetailToDelete)
            {
               ...
               repository.DecorDetails.Delete(e1);
                //dbContext.SaveChanges();
                
            } 
                repository.Save();
            //dbContext.EventTypes.Remove(EventTypeToDelete);
            repository.EventTypes.Delete(EventTypeToDelete);
            //dbContext.SaveChanges();
            repository.Save();
            return RedirectToAction("Index");
        }
